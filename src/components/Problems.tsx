...
const problems: Problem[] = [
    {
        ...
        image: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=800&auto=format",
        color: "bg-red-100",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1628088061640-9924940abb99?q=80&w=2070&auto=format",
        color: "bg-blue-100",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=800&auto=format",
        color: "bg-amber-100",
    ...
    },
    {
        ...
        image: "https://plus.unsplash.com/premium_photo-1661587216211-7d68c0864a05?q=80&w=2070&auto=format",
        color: "bg-purple-100",
    ...
    return (
        <section className="relative bg-brand-light py-20 lg:py-28">
            <div className="max-w-7xl mx-auto px-6">
                {/* Header */}
                <Header subtitle="Common Problems" titleFirst="Are you facing any of" titleSecond="these issues?" />
