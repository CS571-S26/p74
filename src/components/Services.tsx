...
const services = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1631248055158-edec7a3c072b?q=80&w=600&auto=format",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=600&auto=format",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?q=80&w=600&auto=format",
    ...
    <section className="relative bg-gradient-to-b from-white to-brand-light py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Header
          ...
          titleFirst="Let us take care of"
          titleSecond="your eyes!"
        />
