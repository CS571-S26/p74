...
const images = [
  [
    "https://plus.unsplash.com/premium_photo-1677333507982-191efa209bc8?q=80&w=987&auto=format",
    "Eye exam",
  ],
  [
    "https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=600&auto=format",
    "Eye care",
  ],
  [
    "https://plus.unsplash.com/premium_photo-1661281397737-9b5d75b52beb?q=80&w=2069&auto=format",
    "Medical team",
  ],
  [
    "https://images.unsplash.com/photo-1631248055158-edec7a3c072b?q=80&w=2061&auto=format",
    "Medical team",
  ],
];
      ...
      <div className="relative max-w-7xl mx-auto px-10 py-30 lg:py-40 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6 font-display">
            <span className="text-brand">Dr. Trang Eye Clinic</span> - Caring
            for your eyes with our heart
          </h1>
          <p className="text-gray-700 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-10 font-vietnam-pro font-thin">
            We not only provide comprehensive examination and treatment services
            for eye diseases with high professional expertise and advanced
            techniques, but also with the enthusiasm and dedication of our
        ...
        {/* Right: Image Stack */}
        <div className="flex-1 w-full max-w-xl lg:max-w-none pt-10 lg:pt-0">
